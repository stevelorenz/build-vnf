...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="DPDK_UDP_NC APP Runner",
    ...
    parser.add_argument(
        "-m", "--mem", type=int, default=100, help="memory to allocate in MB"
    )
    parser.add_argument(
        "-o",
        "--operation",
    ...
    parser.add_argument(
        "--debug", action="store_true", help="run APP with debugging mode"
    )
    parser.add_argument("--kni_mode", action="store_true", help="run APP with KNI mode")
