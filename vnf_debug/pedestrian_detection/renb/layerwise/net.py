...
with tf.name_scope('input'):
    x = tf.placeholder(tf.float32, shape=[
                       n_input_imgs, input_height, input_width, 3])
...
def max_pool_layer(input_tensor, kernel_size, stride, padding):
    pooling_result = tf.nn.max_pool(input_tensor, ksize=[
                                    1, kernel_size, kernel_size, 1], strides=[1, stride, stride, 1], padding=padding)
...
n_params_2 = n_params_1 + 3*3*16*32 + 32*4
...
n_params_3 = n_params_2 + 3*3*32*64 + 64*4
...
n_params_4 = n_params_3 + 3*3*64*128 + 128*4
...
n_params_5 = n_params_4 + 3*3*128*256 + 256*4
...
n_params_6 = n_params_5 + 3*3*256*512 + 512*4
...
n_params_7 = n_params_6 + 3*3*512*1024 + 1024*4
...
n_params_8 = n_params_7 + 3*3*1024*1024 + 1024*4
...
# Linear output!
o9 = h9
# There is not batch norm, so n_params is: kernel_size + n_biases
n_params_9 = n_params_8 + 1*1*1024*125 + 125

print('Total number of params = {}'.format(n_params))
params = [n_params_1, n_params_2, n_params_3, n_params_4, n_params_5, n_params_6, n_params_7, n_params_8, n_params_9]
###########################################################################################################
