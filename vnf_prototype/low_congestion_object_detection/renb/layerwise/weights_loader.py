...
def load_conv_layer_bn(name, loaded_weights, shape, offset):
    ...
    kernel_weights = np.reshape(
        kernel_weights, (shape[3], shape[2], shape[0], shape[1]), order='C')
