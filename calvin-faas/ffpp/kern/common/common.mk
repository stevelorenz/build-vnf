...
COMMON_DIR ?= ../common/
# libbpf.a must be found in LIBBPF_DIR
LIBBPF_DIR ?= /usr/lib64/
LIBBPF_INCLUDE ?= /opt/libbpf/include
...
$(OBJECT_LIBBPF):
	@if [ ! -d $(LIBBPF_DIR) ]; then \
		echo "Error: Can not find libbpf library."; \
		exit 1; \
	fi
