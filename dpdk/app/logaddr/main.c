 ...
 *
 * About: Log IP and MAC infos of all received packets into a file
 * MARK: Used for learning DPDK APP programming, no performance consideration.
 */
...
l2fwd_mac_updating(struct rte_mbuf *m, unsigned dest_portid)
{
        ...
        /* MARK: Update the destination MAC address */
        /* 02:00:00:00:00:xx */
 ...
 */
static void log_rx_pkt(struct rte_mbuf *m)
{
        ...
        eth = rte_pktmbuf_mtod(m, struct ether_hdr *);
        /* MAC addresses */
        uint64_t src_mac = eth->s_addr.addr_bytes[0];
        printf("SRC MAC: %ld\n", src_mac);
...
main(int argc, char **argv)
{
        ...
        printf("[DEBUG] Number of detected ports: %d\n", nb_ports);
        if (nb_ports == 0)
        ...
        /* MARK: Just used for debug, put unused but defined functions here */
        print_stats();
}
